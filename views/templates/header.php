        ...
        <nav class="header__navegacion">
            <?php if(is_auth()) { ?>
                ...
                <form method="POST" action="/logout" class="header__form">
                    <input value="Cerrar Sesion " type="submit" class="header__submit">
                </form>
            <?php } else { ?>
...
<div class="barra">
    <div class="barra__contenido">
        ...
        <nav class="navegacion">
            ...
            <a href="/workshop-conferencias" class="navegacion__enlace <?php echo pagina_actual('/workshop-conferencias') ? 'navegacion__enlace--actual' : ''; ?>">Conferencias</a>
