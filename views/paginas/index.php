        ...
        <?php foreach ($ponentes as $ponente) { ?>
            <div <?php echo aos_animacion(); ?> class="speaker">
                <div class="speaker__item">
                    <div class="speaker__item__bg"></div>
                    <picture>
                    ...
                    <div class="speaker__item__box">
                        <div class="speaker__item__box__informacion">
                            <h4 class="speaker__item__box__informacion__nombre">
                                <?php echo $ponente->nombre . " " . $ponente->apellido ?>
                            </h4>

                            <p class="speaker__item__box__informacion__ubicacion">
...
<section class="boletos">
    ...
    <div class="boletos__grid">
        <div <?php echo aos_animacion(); ?> class="boleto boleto--presencial">
            <h4 class="boleto__logo">&#60;DevWebCamp/></h4>         
            <p class="boleto__plan">Presencial</p>
            <p class="boleto__precio">$200</p>                      
        </div>

        <div <?php echo aos_animacion(); ?> class="boleto boleto--virtual">
            <h4 class="boleto__logo">&#60;DevWebCamp/></h4>         
            <p class="boleto__plan">Virtual</p>
            <p class="boleto__precio">$50</p>                      
        </div>

        <div <?php echo aos_animacion(); ?> class="boleto boleto--gratis">
            <h4 class="boleto__logo">&#60;DevWebCamp/></h4>         
