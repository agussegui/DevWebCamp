...
class ActiveRecord {
    ...
    //El primer registro lo extrae del arreglo es lo que hace array
    ...
    // Obtener todos los Registros. El metodo all toma un valor ($orden) y si no esta presente esa valor toma el valor por defecto DESCENDIENTE
