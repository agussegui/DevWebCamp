...
class Paginacion {
    ...
    public function __construct($pagina_actual = 1, $registros_por_pagina = 10, $total_registros = 0)
    {
        ...
        $this->total_registros = (int) $total_registros; // (int) = castea un valor osea convertir un valor a otro, de un string a un entero
    }
    ...
    //calculo que si estoy en la pagina uno no vaya a la 0
    public function pagina_anterior(){
        $anterior = $this->pagina_actual -1;
        return ($anterior > 0) ? $anterior : false;
    }

    //calculo si hay 200 paginas no vaya a las 201 que no existe o detecta si podes ir a una pagina siguiente o no
    ...
    //Muestro las paginas siguiente y anterior
